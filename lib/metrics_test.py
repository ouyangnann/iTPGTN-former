...
class PyTorchRMSETestCase(unittest.TestCase):
    def test_masked_mse_null(self):
        ...
        rmse = metrics.masked_mse_torch(preds=preds, labels=labels, null_val=0)
    ...
    def test_masked_mse_vanilla(self):
        ...
        rmse = metrics.masked_mse_torch(preds=preds, labels=labels)
    ...
    def test_masked_mse_all_nan(self):
        ...
        rmse = metrics.masked_mse_torch(preds=preds, labels=labels, null_val=np.nan)
        self.assertAlmostEqual(0., rmse.item(), delta=1e-5)
